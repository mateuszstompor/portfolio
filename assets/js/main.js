...
sr.reveal('.home__img, .about__subtitle, .about__text, .skills__img, .skills__img2',{delay: 400}); 
sr.reveal('.home__social-icon',{ interval: 200}); 
sr.reveal('.skills__data, .work__img, .contact__input, .visually-hidden',{interval: 200}); 
